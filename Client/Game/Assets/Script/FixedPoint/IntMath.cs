...
namespace FixPoint
{
	public class IntMath
	{
		...
		public static readonly VInt PIHalf = new VInt (1571);
		public static readonly VInt PI = new VInt( 3142);
		public static readonly VInt PI2 = new VInt( 6283);
		public static readonly VInt Rad2Deg = new VInt(180L*1000*1000/PI.i);
		public static readonly VInt Deg2Rad = new VInt(PI.i/180);

		public static VInt Pi => PI;

		public static VInt Atan2(VInt y, VInt x)
		{
		...
		public static VInt Atan2(int y, int x)
		{
			if (x == 0)
			{
				...
				else if (y < 0) { return 0-PIHalf; }
				else return 0;
			}
			if (y == 0)
			{
				if (x > 0) return VInt.zero;
				else if (x < 0) { return PI; }
				else return VInt.zero;
			}
		...
		{
			int num = (int)IntMath.Divide(val.i * (long)AcosLookupTable.HALF_COUNT ,1000) +
					  AcosLookupTable.HALF_COUNT;
			num = (int)Clamp(num, 0, AcosLookupTable.COUNT);
			return new VInt(AcosLookupTable.table[num] / 10);
		}

		public static VInt Asin(VInt val)
		{
			int num = (int)IntMath.Divide(val.i * (long)AsinLookupTable.HALF_COUNT ,1000) +
					  AsinLookupTable.HALF_COUNT;
			num = (int)Clamp(num, 0, AsinLookupTable.COUNT);
			return new VInt(AsinLookupTable.table[num] / 10);
		}

		//ccw
		public static VInt Sin(VInt radians)
		{
			int index = SinCosLookupTable.getIndex(radians.i,1000);
			return new VInt(SinCosLookupTable.sin_table[index] / 10);
		}
		...
		{
			int index = SinCosLookupTable.getIndex(radians.i,1000);
			return new VInt(SinCosLookupTable.cos_table[index] / 10);
		}

		public static void SinCos(out VInt s, out VInt c, VInt radians)
		{
			int index = SinCosLookupTable.getIndex(radians.i, 1000);
			s = new VInt(SinCosLookupTable.sin_table[index] / 10);
			c = new VInt(SinCosLookupTable.cos_table[index] / 10);
		}
