...
namespace FixPoint
{
	...
	public struct VInt
	{
		public static readonly VInt one = new VInt(1000);
		public static readonly VInt zero = new VInt(0);
		public static readonly VInt half = new VInt(500);
		public int i;
		...
		public static VInt operator *(VInt a, VInt b)
		{
			...
			return new VInt((int)IntMath.Divide((long)a.i*(long)b.i,1000));
		}
		public static VInt operator /(VInt a, VInt b)
		{

			return new VInt((int)IntMath.Divide((long)a.i *1000 ,(long)b.i));
		}
